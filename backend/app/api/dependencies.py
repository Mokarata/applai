...
from app.services import (ChatService, CompanyService, CoverLetterService,
                          GeminiService, GroqService, JobService,
                          LLMServiceProtocol, OpenAIService, UserService)
...
def get_user_service(
    ...
    """Provides an instance of the UserService with a database session. LLM is optional."""
...
def get_chat_service(
    ...
    """Provides an instance of the ChatService with an LLM service."""
