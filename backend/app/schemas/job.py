...
class JobExtractedData(BaseModel):
    ...
    job_summary: Optional[str] = Field(
        None,
        description="A concise 2-3 sentence summary of the job role, responsibilities, and key requirements.",
        examples=[
            "Senior Software Engineer role at a fast-paced tech company, focusing on backend development with Python and AWS. Requires 5+ years of experience."
        ],
    )
