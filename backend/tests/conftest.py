...
from app.api.dependencies import (get_company_service, get_db, get_job_service,
                                  get_llm_service)
from app.core.config import settings
from app.db.database import Base
from app.db.models import Company, Job, User
from app.schemas import (CompanyCreate, CoverLetterStructure, JobCreate,
                         UserCreate)
from app.services import (CompanyService, JobService, LLMServiceProtocol,
                          UserService)
...
async def client(
    ...
    """
    from app.main import app  # Import app here to avoid premature loading
